          ...
          <div className='auth-card-top-input-container'>
            {page === 1 ? (
              ...
              <>
                ...
                <InputBox label='핸드폰 번호*' type='text' placeholder='핸드폰 번호를 입력해주세요.' error={telNumberError || telNumberDuplicationError} helper={telNumberError ? '숫자만 입력해주세요.' : telNumberDuplicationError ? '종복되는 휴대전화번호입니다.' : ''} value={telNumber} setValue={setTelNumber} />
